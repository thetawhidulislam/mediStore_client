...
export default function CheckoutPage({ cartInfo }: CheckoutPageProps) {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      // const hasError = res?.error || res?.data?.error;

      // if (hasError && hasError !== null) {
      //   toast.error(hasError || "Something went wrong", { id: toastId });
      //   return;
      // }
      const stripeUrl = res?.data?.paymentUrl || res?.paymentUrl;

      // 💳 পেমেন্ট গেটওয়ে যদি STRIPE হয়
      if (paymentMethod === "STRIPE") {
        if (stripeUrl) {
          ...
          // সরাসরি স্ট্রাইপ চেকআউট পেজে রিডাইরেক্ট করবে
